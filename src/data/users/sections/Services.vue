<script setup>
import features from '../request/services.js';
import { ref } from 'vue';
...
<template>
    ...
    <div id="services" class="container mx-auto px-5">
        <section class="py-10">
            <div class="w-4/5 md:w-3/5 mx-auto">
                <h2 class="text-3xl md:text-4xl font-semibold font-theme-heading text-center">Services</h2>
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Our Barangay Document Services are designed to provide residents with quick and convenient access to essential local documents. We strive to make the process as seamless as possible, ensuring that you receive the necessary paperwork efficiently and accurately. Below is an overview of the services we offer:</p>
            </div>
                    ...
                    <div v-show="isOpen === feature.id" class="grid gap-32 lg:grid-cols-2 items-center">
                        ...
                        <div>
                            ...
                            <div class="flex justify-center lg:justify-start mt-7">
                                <LinkButton btn-type="primary" :link="feature.details.link">PROCEED</LinkButton>
                            </div>
                        </div>
                    </div>
                </template>
